...
Figure \ref{fig:mu_errors_nmf}. This display confirms our earlier observation,
that posterior Gibbs samples seem more reliable than either those from VB or the
bootstrap, when using generic probabilistic programming for the Dynamic Unigram
model, at least in problems with the dimensions we have considered.
