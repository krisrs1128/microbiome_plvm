...
but to place a common prior across all $\left(\beta_{k}^{s}\right_{k, s}$. This
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_1}
  \caption{Rather than displaying all representative species together, as in
    Figure \ref{topic_prototypes}, we can sort species according to how
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_2}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_3}
  \caption{The analog of Figure \ref{fig:species_prototypes_1} for Topic
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_4}
  \caption{The analog of Figure \ref{fig:species_prototypes_1} for Topic
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.8\textwidth]{figure/uneven_taxa_facet}
