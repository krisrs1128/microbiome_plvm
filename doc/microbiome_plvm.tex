...
\begin{figure}[!p]
  ...
  \caption{Rather than displaying all representative species together, as in
    ...
    scale. \label{fig:species_prorotypes_1} }
\end{figure}
...
\begin{figure}[!p]
  ...
  \caption{The analog of Figure \ref{fig:species_prototypes_1} for Topic
    2.\label{fig:species_prorotypes_2}. }
\end{figure}

\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_3}
  \caption{The analog of Figure \ref{fig:species_prorotypes_1} for Topic
    3. \label{fig:species_prorotypes_3} }
\end{figure}

\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{figure/species_prototypes_4}
  \caption{The analog of Figure \ref{fig:species_1} for Topic
    4. \label{fig:species_prorotypes_4} }
\end{figure}
