...
\begin{figure}[!p]
  \centering\includegraphics[scale=0.15]{figure/beta_contours_v10}
...
\begin{figure}[!p]
  \centering
  \includegraphics[scale=0.9]{figure/beta_errors_lda}
...
\begin{figure}[!p]
  \centering
  \includegraphics[scale=0.9]{figure/beta_errors_nmf}
...
\begin{figure}[!p]
  \centering
  \includegraphics[scale=0.15]{figure/posterior_check_evals-F}
...
\begin{figure}[!p]
  ...
  \caption{The eigenvalues displayed in Figure
    ...
    provide scores for each species. The individual posterior samples have been
