...
\simplex{D}$, we plot $g\left(\mathbf{p}\right) := \left(\log p_{1} -
...
Topics 2 seems to be overrepresented during the antibiotic treatments. Topic 2
is elevated immediately after the antibiotic treatment. Topic 4 seems to
...
Topics 3 and 4 are learned from the data without enforcing any temporal
...
species associated with a specific credible interval. To address this, we have
...
highlighting outlier speciess: we can look at the average discrepancy between
