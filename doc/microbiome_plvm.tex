...
\beta_{k^{\prime} v}$. This allows an interpretation of the topics in terms of
the raw data, and the display reinforces the findings of Figures
\ref{fig:antibiotics_lda_theta} and \ref{fig:antibiotics_lda_beta}. Instead of
displaying all species together, Supplementary Figures
