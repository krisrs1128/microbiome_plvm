...
\footnotetext{To whom correspondence should be addressed. krissankaran@stanford.edu}
...
\begin{figure}[!p]
  \centering\includegraphics[width=\textwidth]{beta_contours_v10.png}
...
\section{Figures}
\begin{figure}[!p]
  \centering\includegraphics{visualize_lda_theta_boxplot-F}
...
\begin{figure}[!p]
  \centering\includegraphics{visualize_lda_beta-F}
...
\begin{figure}[!p]
  \centering
  \includegraphics{antibiotics_unigram_mu-F}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=\textwidth]{beta_contours_v50}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=\textwidth]{beta_contours_nmf}
