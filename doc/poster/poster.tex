...
\setlength{\onecolwid}{0.48\paperwidth}
\setlength{\twocolwid}{0.464\paperwidth}
\setlength{\threecolwid}{0.708\paperwidth}
\setbeamersize{text margin left=0.1cm,text margin right=0.1cm, text margin top=0.0cm}
...
\begin{figure}[!p]
  \centering\includegraphics[width=0.85\textwidth]{../figure/visualize_lda_theta_boxplot-F}
...
\begin{figure}[!p]
  \centering\includegraphics[width=0.85\textwidth]{../figure/visualize_lda_beta-F}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\textwidth]{../figure/antibiotics_unigram_mu-F}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.7\textwidth]{../figure/posterior_check_ts-F}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.6\textwidth]{../figure/posterior_check_scores-loadings-F}
  \caption{
