...
\usepackage[size=custom,width=30,height=40,scale=0.3]{beamerposter}
\usetheme{confposter}
...
\setlength{\onecolwid}{0.1\paperwidth}
...
\begin{figure}[!p]
  \centering
  \includegraphics[width=0.76\textwidth]{../figure/posterior_check_ts-F}
