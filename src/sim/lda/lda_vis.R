...
## ---- betacontours1 ----
ggsave(file.path(base_dir, "doc", "figure/betacontours1-1.png"), p[[1]])

## ---- betacontours2 ----
ggsave(file.path(base_dir, "doc", "figure/betacontours2-1.png"), p[[2]])

## ---- betahistograms ----
p <- error_histograms(mcombined, c("V + method", "D + N"))
ggsave(file.path(base_dir, "doc", "figure/betahistograms-1.png"), p)
...
## ---- betaboxplot1 ----
ggsave(file.path(base_dir, "doc", "figure/betaboxplot1-1.png"), p[[1]])

## ---- betaboxplot2 ----
ggsave(file.path(base_dir, "doc", "figure/betaboxplot2-1.png"), p[[2]])
...
## ---- thetaboxplot1 ----
ggsave(file.path(base_dir, "doc", "figure/thetaboxplot1-1.png"), p[[1]])

## ---- thetaboxplot2 ----
ggsave(file.path(base_dir, "doc", "figure/thetaboxplot2-1.png"), p[[2]])

## ---- thetahistograms ----
p <- error_histograms(mcombined, c("D + method", "V + N"))
ggsave(file.path(base_dir, "doc", "figure/thetahistograms-1.png"), p)
