...
theme_set(ggscaffold::min_theme(list(text_size = 12, subtitle_size = 14)))
set.seed(11242016)
...
ggsave(sprintf("%s/posterior_check_hists.png", output_dir), p[["hists"]], width = 5, height = 3)
ggsave(sprintf("%s/posterior_check_quantiles.png", output_dir), p[["quantiles"]], width = 3, height = 2)
ggsave(sprintf("%s/posterior_check_margins.png", output_dir), p[["margins"]], width = 5, height = 3)
ggsave(sprintf("%s/posterior_check_ts.png", output_dir), p[["ts"]], width = 5, height = 3)
ggsave(sprintf("%s/posterior_check_scores.png", output_dir), p[["scores"]], width = 5, height = 3)
ggsave(sprintf("%s/posterior_check_loadings.png", output_dir), p[["loadings"]], width = 5, height = 3)
ggsave(sprintf("%s/posterior_check_evals.png", output_dir), p[["evals"]], width = 1, height = 1)
